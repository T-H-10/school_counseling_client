...
const INITIAL_FORM = { event_type: 'meeting', date: '', title: '', description: '' }
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              נושא <span className="text-sm font-medium text-red-400">*</span>
            </label>
            <input
              type="text"
              name="title"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              סיכום / הערות <span className="text-red-400">*</span>
            </label>
            <textarea
              name="description"
